  ...
  return (
    <>
      ...
      <button
        ...
        className="md:hidden fixed top-4 left-4 z-50 p-2.5 rounded-xl bg-[#0e1017]/90 border border-slate-800 backdrop-blur-xl text-white"
      ...
      <aside
        className={`w-64 min-h-screen bg-[#090b10]/95 border-r border-slate-800/80 flex flex-col justify-between p-4 fixed left-0 top-0 z-50 backdrop-blur-xl transition-transform duration-300 ${
          abierto ? 'translate-x-0' : '-translate-x-full'
        } md:translate-x-0`}
      >
        <div>
          {/* Header / Logo animado */}
          <div className="px-3 py-4 mb-6 border-b border-slate-800/60 group cursor-pointer flex items-center justify-between">
            <div>
